...
class ScreenieModelPropertiesDialog : public QDialog
{
    Q_OBJECT
public:
    ScreenieModelPropertiesDialog(ScreenieModelInterface &screenieModel, ScreenieControl &screenieControl, QWidget *parent = nullptr, Qt::WindowFlags flags = Qt::WindowFlags());
