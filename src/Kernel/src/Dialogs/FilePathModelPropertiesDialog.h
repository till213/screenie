...
class FilePathModelPropertiesDialog : public ScreenieModelPropertiesDialog
{
    Q_OBJECT
public:
    FilePathModelPropertiesDialog(ScreenieFilePathModel &templateModel, ScreenieControl &screenieControl, QWidget *parent = nullptr, Qt::WindowFlags flags = Qt::WindowFlags());
